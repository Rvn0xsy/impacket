...
FILE_SHARE_READ = (
    0x00000001  # Other open operations can be performed on the file for read access.
)
FILE_SHARE_WRITE = (
    0x00000002  # Other open operations can be performed on the file for write access.
)
FILE_SHARE_DELETE = (
    0x00000004  # Other open operations can be performed on the file for delete access.
)
...
FILE_DELETE_CHILD = (
    0x00000040  # This value indicates the right to delete entries within a directory.
)
FILE_EXECUTE = 0x00000020  # This value indicates the right to execute the file.
FILE_READ_ATTRIBUTES = (
    0x00000080  # This value indicates the right to read the attributes of the file.
)
FILE_WRITE_ATTRIBUTES = (
    0x00000100  # This value indicates the right to change the attributes of the file.
)
...
class SMB2Negotiate(Structure):
    structure = (
        ...
        (
            "ClientStartTime",
            '8s=""',
        ),  # or (NegotiateContextOffset/NegotiateContextCount/Reserved2) in SMB 3.1.1
        ("Dialects", "*<H"),
        # SMB 3.1.1
        ("Padding", ':=""'),
...
class SMB2Negotiate_Response(Structure):
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["SecurityBufferOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
        ...
        (
            ...
            '0 if self["NegotiateContextOffset"] == 0 else '
...
class SMB2Create(Structure):
    ...
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["NameOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2Create_Response(Structure):
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["CreateContextsOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2Read(Structure):
    ...
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["ReadChannelInfoOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2Read_Response(Structure):
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["DataOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2Ioctl(Structure):
    ...
    structure = (
        ...
        (
            "OutputOffset",
            '<L=(self.SIZE + 64 + len(self["AlignPad"]) + self["InputCount"])',
        ),
        ("OutputCount", "<L=0"),
...
class SMB2Ioctl_Response(Structure):
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["OutputOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
        ("_Buffer", "_-Buffer", 'self["InputCount"]+self["OutputCount"]'),
        ("Buffer", ":"),
...
class SMB2QueryDirectory(Structure):
    ...
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["FileNameOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2QueryDirectory_Response(Structure):
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["OutputBufferOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class SMB2QueryInfo(Structure):
    ...
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["InputBufferOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
...
class FILE_ACCESS_INFORMATION(Structure):
    structure = (("AccessFlags", "<L"),)


class FILE_POSITION_INFORMATION(Structure):
    structure = (("CurrentByteOffset", "<Q"),)
...
class FILE_ALIGNMENT_INFORMATION(Structure):
    structure = (("AlignmentRequirement", "<L"),)
...
class SMB2SetInfo(Structure):
    ...
    structure = (
        ...
        (
            "_AlignPad",
            "_-AlignPad",
            'self["BufferOffset"] - (64 + self["StructureSize"] - 1)',
        ),
        ("AlignPad", ':=""'),
        ("_Buffer", "_-Buffer", 'self["BufferLength"]'),
        ("Buffer", ":"),
